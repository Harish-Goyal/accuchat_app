...
//   @override
//   Widget build(BuildContext context) {
//     bool isMe = me?.userId == widget.message?.fromUser?.userId;
//     return InkWell(
//         onTap: () {
...
//     //     widget.message.message.startsWith("https://firebasestorage")) {
...
//                     ? Text(
//                         "${widget.message.replyToSenderName}: ${extractFileNameFromUrl(widget.message)}",
...
//                       onTap: () {
//
//                         Get.toNamed(AppRoutes.taskTreadsRoute,
//                             arguments: {
//                               'taskMsg': widget.message, 'currentUser': widget.user!
//                             });
//                       },
//                       child: Container(
...
//     return Container(); StatefulBuilder(builder: (context, setStateInside) {
...
//
//     final isCreator = widget.message?.fromUser?.userId == me?.userId;
//
...
//     await Container()showModalBottomSheet(
//         context: context,
