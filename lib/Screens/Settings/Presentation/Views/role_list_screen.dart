        ...
        return Scaffold(
          ...
          body: ctrl.isLoadingRoles
            ...
            child: ConstrainedBox(
              ...
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: isWide ? 16 : 8,vertical: 5),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        TextButton(onPressed: (){ctrl.editRole(role);}, child: const Icon(Icons.edit_rounded,color: Colors.black87,)),
                                      ],
                                    ),
                                      ...
                                      children: (grouped.entries).map((entry) {
                                        ...
                                        return IntrinsicWidth(
                                          child: ConstrainedBox(
                                            constraints:  BoxConstraints(
                                              maxWidth: Get.width,
                                              minWidth:isWide && kIsWeb? 270:Get.width,
                                            ),
                                            child: Container(
                                                ...
                                                child: ExpansionTile(
                                                  ...
                                                  title: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      hGap(5),
                                                      Flexible( // ✅ use Flexible, not Expanded
                                                        child: Text(
                                                          place.toUpperCase(),
                                                          maxLines: 1,
