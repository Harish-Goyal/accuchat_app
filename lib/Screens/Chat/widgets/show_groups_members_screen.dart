...
class _GroupMembersScreenState extends State<GroupMembersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title:  Text('Group Members',style:BalooStyles.balooboldTitleTextStyle()),
        actions: [
        ...
        children: [
          ...
          const CircleAvatar(
            ...
            CustomTextField(
              ...
              validator: (value) {
                return value?.isEmptyField(messageTitle:"Group Name" );
              },
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(
                    user.phone==''||user.phone=='null'||user.phone==null?user.email:user.phone,
